...
import ee
from hansen_labels import HANSEN_LABELS, HANSEN_LABELS_SHORT
...
# Detailed labels for all 256 Hansen classes imported from hansen_labels.py
# Which contains accurate descriptions from legend_glcluc.csv
