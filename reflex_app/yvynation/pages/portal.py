    ...
    return rx.box(
        rx.vstack(
            ...
            rx.hstack(
                ...
                # Indigenous Lands Analysis Card
                rx.box(
                    rx.vstack(
                        rx.heading(
                            AppState.tr["indigenous_analysis_label"],
                            size="3",
                            text_align="center",
                            color="#15803d",
                        ),
                        rx.text(
                            AppState.tr["portal_indigenous_sub"],
                            font_size="sm",
                            text_align="center",
                            color="#666",
                            margin_bottom="0.75rem",
                        ...
                        rx.unordered_list(
                            rx.list_item(AppState.tr["portal_indigenous_i1"]),
                            rx.list_item(AppState.tr["portal_indigenous_i2"]),
                            rx.list_item(AppState.tr["portal_indigenous_i3"]),
                            rx.list_item(AppState.tr["portal_indigenous_i4"]),
                            font_size="sm",
                            color="#333",
                            line_height="1.8",
                        ),
                        rx.spacer(),
                        rx.button(
                            AppState.tr["portal_indigenous_btn"],
                            on_click=lambda: AppState.go_to_territory_analysis("indigenous"),
                            size="2",
                            color_scheme="green",
                            width="100%",
                            font_weight="bold",
                ...
                # Conservation Units Analysis Card
                rx.box(
                    rx.vstack(
                        rx.heading(
                            AppState.tr["conservation_analysis_label"],
                            size="3",
                            text_align="center",
                            color="#0f766e",
                        ),
                        rx.text(
                            AppState.tr["portal_conservation_sub"],
                            font_size="sm",
                            text_align="center",
                            color="#666",
                            margin_bottom="0.75rem",
                        ),
                        rx.divider(border_color="#99f6e4"),
                        rx.unordered_list(
                            rx.list_item(AppState.tr["portal_conservation_i1"]),
                            rx.list_item(AppState.tr["portal_conservation_i2"]),
                            rx.list_item(AppState.tr["portal_conservation_i3"]),
                            rx.list_item(AppState.tr["portal_conservation_i4"]),
                            font_size="sm",
                            color="#333",
                            line_height="1.8",
                        ),
                        rx.spacer(),
                        rx.button(
                            AppState.tr["portal_conservation_btn"],
                            on_click=lambda: AppState.go_to_territory_analysis("conservation"),
                            size="2",
                            color_scheme="teal",
                            width="100%",
                            font_weight="bold",
                    ...
                    flex="1",
                    min_width="240px",
                    box_shadow="0 4px 6px rgba(15, 118, 110, 0.1)",
                    transition="all 0.3s ease",
                ),
