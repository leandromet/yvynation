...
TRANSLATIONS_EN = {
    ...
    "main_page_title": "Yvynation - Land Monitoring Platform",
    "app_title": "Yvynation",
    "app_subtitle": "Land Monitoring Platform",
    ...
    "area_basis_note": "Area is computed from each pixel's true geodesic size (Earth Engine pixelArea), not a fixed 900 m² (0.09 ha) assumption — this stays accurate at any latitude.",
...
**Charts**: Bar charts show top 15 classes. Sankey diagrams show land cover transitions. Gains & Losses bars show increases (right) and decreases (left).""",
    ...
    "nav_hide": "☰ Hide",
    "nav_show": "☰ Show",
    # Workspace chrome: sidebar groups, drag handles, drawer sizing
    # (pages/index.py, components/layout.py, components/results_panel.py)
    "group_study_area": "Study area",
    "group_analysis": "Analysis",
    "group_layers": "Map layers",
    "group_help": "Help & legend",
    "sidebar_hide_aria": "Hide the controls panel",
    "sidebar_show_aria": "Show the controls panel",
    "sidebar_resize_aria": "Resize the controls panel — drag, or use the arrow keys; double-click to reset",
    "sheet_handle_aria": "Resize the panel — drag, tap, or use the arrow keys",
    "results_resize_label": "Size",
    "results_resize_aria": "Step the results panel through three heights",
    ...
    "indigenous_analysis_label": "🪶 Indigenous Lands Analysis",
    "portal_indigenous_sub": "Monitor indigenous lands",
    "portal_indigenous_i1": "Select from 650+ indigenous lands",
    "portal_indigenous_i2": "Search by name",
    "portal_indigenous_i3": "Track forest changes (1985-2024)",
    "portal_indigenous_i4": "Compare multiple years",
    "portal_indigenous_btn": "→ Start Indigenous Lands",
    "conservation_analysis_label": "🌿 Conservation Units Analysis",
    "portal_conservation_sub": "Monitor conservation units",
    "portal_conservation_i1": "Select from 3,200+ conservation units",
    "portal_conservation_i2": "Search by name",
    "portal_conservation_i3": "Track forest changes (1985-2024)",
    "portal_conservation_i4": "Compare multiple years",
    "portal_conservation_btn": "→ Start Cons. Units Analysis",
    ...
    "batch_mw_custom_label": "Custom years (3 to 10, comma-separated, 1985–2024)",
    ...
    # Stage flow, filter disclosure and configuration groups
    # (pages/batch_processing.py, components/batch_shared.py,
    #  components/batch_config_panel.py, components/batch_territory_selector.py)
    "batch_stage_select": "Select",
    "batch_stage_configure": "Configure",
    "batch_stage_run": "Run",
    "batch_no_selection_hint": "Select at least one territory before starting — tap to go back to Select.",
    "batch_starting_label": "Starting\u2026",
    "batch_starting_hint": "Preparing the run — this takes a few seconds. Do not click Start again.",
    "batch_filters_toggle": "Filters and lists",
    "batch_list_capped": "Showing the first {shown} of {total} — search or filter to reach the rest. Selecting \u201call filtered\u201d still uses all {total}.",
    "batch_group_years": "Years",
    "batch_group_analyses": "Analyses",
    "batch_group_figures": "Figures and images",
    "batch_group_multiwindow": "Multi-window",
    "batch_group_timeline": "Timeline",
    "batch_group_buffer": "Buffer zone",
    ...
    "batch_start_btn": "🚀 Start Batch Process",
    "territories_word": "territories",
    "batch_confirm_prefix": "This will run Earth Engine analysis for",
    "batch_confirm_suffix": ". Continue?",
    ...
    # =====================================================================
    "export_tab_data": "Data & Figures",
    "export_tab_maps": "PDF Maps",
    "export_tab_report": "Report",
    "report_heading": "Report",
    "report_intro": "A laid-out document: identification, maps, charts and tables with short explanations. Language = the interface's.",
    "report_chk_maps": "Maps",
    "report_chk_figures": "Charts",
    "report_chk_tables": "Summary tables",
    "report_chk_appendix": "Appendix",
    "report_btn_pdf": "PDF",
    "report_btn_html": "HTML",
    "report_stage_snapshot": "Collecting results…",
    "report_stage_maps": "Maps: fetching from Earth Engine…",
    "report_stage_charts": "Charts {n}/{total}",
    "report_stage_compose": "Composing {fmt}…",
    "report_stage_done": "Report ready — download started.",
    "report_disabled_no_result": "Analyse an Indigenous Land or Conservation Unit first. Reports cover territories, not drawn polygons.",
    "report_disabled_busy": "A report is being built…",
    "report_error": "Report failed: {err}",
    "batch_chk_report_pdf": "📄 PDF report per area",
    "batch_report_pdf_hint": "One readable PDF per area, in the interface language: identification, maps, charts and tables with short explanations. Written as territory/<name>/<name>_report.pdf.",
}
