...
3. **Zone Tampon** : créez des zones externes, comparez l'usage des terres à l'intérieur et à l'extérieur""",
    ...
    "nav_hide": "☰ Masquer",
    "nav_show": "☰ Afficher",
    # Structure de l'espace de travail : groupes de la barre latérale,
    # poignées de glissement, redimensionnement du panneau de résultats
    "group_study_area": "Zone d'étude",
    "group_analysis": "Analyse",
    "group_layers": "Couches de la carte",
    "group_help": "Aide et légende",
    "sidebar_hide_aria": "Masquer le panneau de commandes",
    "sidebar_show_aria": "Afficher le panneau de commandes",
    "sidebar_resize_aria": "Redimensionner le panneau de commandes — faites glisser ou utilisez les flèches ; double-clic pour réinitialiser",
    "sheet_handle_aria": "Redimensionner le panneau — faites glisser, touchez ou utilisez les flèches",
    "results_resize_label": "Taille",
    "results_resize_aria": "Faire défiler la hauteur du panneau de résultats entre trois tailles",
    ...
    "indigenous_analysis_label": "🪶 Analyse des Terres Autochtones",
    "portal_indigenous_sub": "Surveillez les terres autochtones",
    "portal_indigenous_i1": "Choisissez parmi 650+ terres autochtones",
    "portal_indigenous_i2": "Recherchez par nom",
    "portal_indigenous_i3": "Suivez les changements forestiers (1985-2024)",
    "portal_indigenous_i4": "Comparez plusieurs années",
    "portal_indigenous_btn": "→ Démarrer l'Analyse des Terres Autochtones",
    "conservation_analysis_label": "🌿 Analyse des Unités de Conservation",
    "portal_conservation_sub": "Surveillez les unités de conservation",
    "portal_conservation_i1": "Choisissez parmi 3 200+ unités de conservation",
    "portal_conservation_i2": "Recherchez par nom",
    "portal_conservation_i3": "Suivez les changements forestiers (1985-2024)",
    "portal_conservation_i4": "Comparez plusieurs années",
    "portal_conservation_btn": "→ Démarrer l'Analyse des Unités de Conservation",
    ...
    "batch_figs_label": "EXPORT DES FIGURES",
    "batch_chk_export_png": "🖼 Exporter aussi les figures en PNG",
    "batch_png_hint": "Le HTML est toujours généré. Les PNG représentent ~90% de la taille de l'archive mais seulement quelques pour cent du temps d'exécution — les désactiver économise de l'espace, pas du temps.",
    "batch_chk_png_high_res": "Pleine résolution (fichiers plus volumineux)",
    "batch_timeline_bands_label": "BANDES DE CONTEXTE DE LA CHRONOLOGIE",
    "batch_chk_timeline_political": "Bande présidents / gouverneurs",
    "batch_chk_timeline_policy": "Lignes de politiques + jalons",
    "batch_chk_timeline_enso": "Bande El Niño / La Niña (ENSO)",
    "batch_timeline_bands_hint": "Chaque bande retirée libère aussi l'espace qu'elle réservait, raccourcissant le graphique.",
    ...
    "batch_mw_custom_label": "Années personnalisées (3 à 10, séparées par des virgules, 1985–2024)",
    ...
    # Flux d'étapes, filtres repliables et groupes de configuration
    "batch_stage_select": "Sélectionner",
    "batch_stage_configure": "Configurer",
    "batch_stage_run": "Exécuter",
    "batch_no_selection_hint": "Sélectionnez au moins un territoire avant de démarrer — touchez pour revenir à Sélectionner.",
    "batch_starting_label": "Démarrage\u2026",
    "batch_starting_hint": "Préparation de l'exécution — cela prend quelques secondes. Ne cliquez pas à nouveau sur Démarrer.",
    "batch_filters_toggle": "Filtres et listes",
    "batch_list_capped": "Affichage des {shown} premiers sur {total} — recherchez ou filtrez pour atteindre le reste. \u00ab Tout sélectionner \u00bb utilise toujours les {total}.",
    "batch_group_years": "Années",
    "batch_group_analyses": "Analyses",
    "batch_group_figures": "Figures et images",
    "batch_group_multiwindow": "Multi-fenêtre",
    "batch_group_timeline": "Chronologie",
    "batch_group_buffer": "Zone tampon",
    ...
    "batch_confirm_prefix": "Cela exécutera l'analyse Earth Engine pour",
    "batch_confirm_suffix": ". Continuer ?",
    ...
    # =====================================================================
    "export_tab_data": "Données et figures",
    "export_tab_maps": "Cartes PDF",
    "export_tab_report": "Rapport",
    "report_heading": "Rapport",
    "report_intro": "Un document mis en page : identification, cartes, graphiques et tableaux avec de courtes explications. Langue = celle de l'interface.",
    "report_chk_maps": "Cartes",
    "report_chk_figures": "Graphiques",
    "report_chk_tables": "Tableaux de synthèse",
    "report_chk_appendix": "Annexe",
    "report_btn_pdf": "PDF",
    "report_btn_html": "HTML",
    "report_stage_snapshot": "Collecte des résultats…",
    "report_stage_maps": "Cartes : récupération depuis Earth Engine…",
    "report_stage_charts": "Graphiques {n}/{total}",
    "report_stage_compose": "Mise en page {fmt}…",
    "report_stage_done": "Rapport prêt — téléchargement lancé.",
    "report_disabled_no_result": "Analysez d'abord une Terre indigène ou une Unité de conservation. Les rapports portent sur des territoires, pas sur des polygones dessinés.",
    "report_disabled_busy": "Un rapport est en cours de génération…",
    "report_error": "Échec du rapport : {err}",
    "batch_chk_report_pdf": "📄 Rapport PDF par zone",
    "batch_report_pdf_hint": "Un PDF lisible par zone, dans la langue de l'interface : identification, cartes, graphiques et tableaux avec de courtes explications. Enregistré sous territory/<nom>/<nom>_report.pdf.",
}
