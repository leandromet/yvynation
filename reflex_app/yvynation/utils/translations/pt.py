...
TRANSLATIONS_PT = {
    ...
    "main_page_title": "Yvynation - Plataforma de Monitoramento Territorial Indígena",
    "app_title": "Yvynation",
    "app_subtitle": "Plataforma de Monitoramento Territorial Indígena",
...
**Gráficos**: Gráficos de barras mostram as 15 principais classes. Diagramas Sankey mostram transições. Barras de Ganhos e Perdas mostram aumentos (direita) e diminuições (esquerda).""",
    ...
    "portal_geometry_btn": "→ Iniciar Análise de Geometria",
    "portal_territory_sub": "Monitore terras indígenas",
    "portal_territory_i1": "Selecione entre 700+ territórios",
    "portal_territory_i2": "Pesquise por nome",
    "portal_territory_i3": "Acompanhe mudanças florestais (1985-2024)",
    "portal_territory_i4": "Compare múltiplos anos",
    "portal_territory_btn": "→ Iniciar Análise de Território",
    ...
    "portal_batch_btn": "→ Iniciar Processamento em Lote",
    ...
    "citation_platform_text": "Biondo, L. M. (2026). Yvynation: plataforma de monitoramento geoespacial de Terras Indígenas e Unidades de Conservação [Software]. Institute for Sustainability, Growth and Health (IGS), UBC Okanagan. Dados processados via Google Earth Engine (projeto ProtectedLandsYvynation-EE).",
    ...
    "batch_mw_custom_label": "Anos personalizados (3 ou 4, separados por vírgula, 1985–2024)",
