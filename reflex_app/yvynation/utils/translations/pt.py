...
**Gráficos**: Gráficos de barras mostram as 15 principais classes. Diagramas Sankey mostram transições. Barras de Ganhos e Perdas mostram aumentos (direita) e diminuições (esquerda).""",
    ...
    "batch_no_selection_hint": "Selecione ao menos um território antes de iniciar — toque para voltar a Selecionar.",
    "batch_starting_label": "Iniciando\u2026",
    "batch_starting_hint": "Preparando a execução — leva alguns segundos. Não clique em Iniciar novamente.",
    ...
    # =====================================================================
    "export_tab_data": "Dados e figuras",
    "export_tab_maps": "Mapas em PDF",
    "export_tab_report": "Relatório",
    "report_heading": "Relatório",
    "report_intro": "Um documento diagramado: identificação, mapas, gráficos e tabelas com explicações curtas. Idioma = o da interface.",
    "report_chk_maps": "Mapas",
    "report_chk_figures": "Gráficos",
    "report_chk_tables": "Tabelas-resumo",
    "report_chk_appendix": "Apêndice",
    "report_btn_pdf": "PDF",
    "report_btn_html": "HTML",
    "report_stage_snapshot": "Reunindo resultados…",
    "report_stage_maps": "Mapas: buscando no Earth Engine…",
    "report_stage_charts": "Gráficos {n}/{total}",
    "report_stage_compose": "Montando {fmt}…",
    "report_stage_done": "Relatório pronto — download iniciado.",
    "report_disabled_no_result": "Analise primeiro uma Terra Indígena ou Unidade de Conservação. Os relatórios cobrem territórios, não polígonos desenhados.",
    "report_disabled_busy": "Um relatório está sendo gerado…",
    "report_error": "Falha no relatório: {err}",
    "batch_chk_report_pdf": "📄 Relatório PDF por área",
    "batch_report_pdf_hint": "Um PDF legível por área, no idioma da interface: identificação, mapas, gráficos e tabelas com explicações curtas. Gravado como territory/<nome>/<nome>_report.pdf.",
}
